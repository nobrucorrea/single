 ...
 * @author bastosbf
 */
public class XMLParserSOAPFinalRJ extends XMLParserAbstratoArquivo {
    ...
    public List<Produto> parse(InputStream xml) {
        ...
        try {
            ...
            DefaultHandler handler = new DefaultHandler() {
                ...
                private boolean CodigoInterno = false;
                private boolean Ncm = false;
                private boolean DescricaoNcm = false;
                private boolean DescricaoCest = false;
                ...
                private boolean CodigoCstIcmsSaidaRevenda = false;
                private boolean IcmsSaidaRevenda = false;
                ...
                private boolean PiscofinsSituacao = false;
                private boolean CodigoCstPisCofinsEntrada = false;
                private boolean CodigoCstPisCofinsSaida = false;
                private boolean CodigoCsosn = false;
                private boolean PisCofinsNaturezaReceita = false;
                ...
                public void startElement(String uri, String localName, String qName,
                    ...
                    if (qName.equalsIgnoreCase("CodigoInterno")) {
                        CodigoInterno = true;
                    }
                    ...
                    if(qName.equalsIgnoreCase("DescricaoCest")){
                        DescricaoCest = true;
                    }
                    ...
                    if (qName.equalsIgnoreCase("CodigoCstIcmsSaidaRevenda")) {
                        CodigoCstIcmsSaidaRevenda = true;
                    }
                    if (qName.equalsIgnoreCase("IcmsSaidaRevenda")) {
                        IcmsSaidaRevenda = true;
                    }
                    ...
                    if(qName.equalsIgnoreCase("CodigoCsosn")){
                        CodigoCsosn =true;
                    }
                    if(qName.equalsIgnoreCase("PisCofinsSituacao")){
                        PiscofinsSituacao = true;
                    }
                    
                    if(qName.equalsIgnoreCase("PisCofinsNaturezaReceita")){
                        PisCofinsNaturezaReceita = true;
                    }
                ...
                public void characters(char ch[], int start, int length) throws SAXException {
                    ...
                    if (CodigoInterno) {
                        produto.setCodigoInterno(new String(ch, start, length));
                        CodigoInterno = false;
                    }
                    if (Ncm) {
                    ...
                    if(DescricaoCest){
                        produto.setDescricaoCest(new String(ch, start, length));
                        DescricaoCest = false;
                    }
                    if (Ipi) {
                    ...
                    if (CodigoCstIcmsSaidaRevenda) {
                        produto.setIcmsCstSaidaRevenda(new String(ch, start, length));
                        CodigoCstIcmsSaidaRevenda = false;
                    }
                    if (IcmsSaidaRevenda) {
                        produto.setIcmsSaidaRevenda(new String(ch, start, length));
                        IcmsSaidaRevenda = false;
                    }
                    ...
                    if(CodigoCsosn){
                        produto.setCodigoCSosn(new String(ch, start, length));
                        CodigoCsosn=false;
                    }
                    
                    if(PiscofinsSituacao){
                        produto.setPisconfinsSituacao(new String(ch, start, length));
                        PiscofinsSituacao = false;
                    }
                    
                    if(PisCofinsNaturezaReceita){
                         produto.setPisCofinsNaturezaReceita(new String(ch, start, length));
                       PisCofinsNaturezaReceita = false;
                    }
                }
            };
